...
## [0.32.0](https://github.com/partcyborg/tanka/compare/v0.31.2...v0.32.0) (2025-03-04)


### 🎉 Features

* **actions:** Pin commit SHAs ([#1111](https://github.com/partcyborg/tanka/issues/1111)) ([c11c35f](https://github.com/partcyborg/tanka/commit/c11c35fcd1f60887dcf753f1a8b865467bdbc88e))
* Add acceptance tests ([#1040](https://github.com/partcyborg/tanka/issues/1040)) ([9803259](https://github.com/partcyborg/tanka/commit/98032597c18276086bc6f7419cf3a7e36c399fb7))
* add support for overriding environment label ([#824](https://github.com/partcyborg/tanka/issues/824)) ([#975](https://github.com/partcyborg/tanka/issues/975)) ([b44bdc9](https://github.com/partcyborg/tanka/commit/b44bdc9a210e4b9c734afa89e9a049c4112576ae))
* allow using external variables in export and env list   ([#1112](https://github.com/partcyborg/tanka/issues/1112)) ([80ffbfd](https://github.com/partcyborg/tanka/commit/80ffbfd423f988b14641ee38fc158919c45d8586))
* **ci:** run on real arm64 builders ([#1193](https://github.com/partcyborg/tanka/issues/1193)) ([54132fd](https://github.com/partcyborg/tanka/commit/54132fd3da280b4e9a55a066635809e7f8588318))
* **ci:** run required checks on merge groups ([#1192](https://github.com/partcyborg/tanka/issues/1192)) ([1cfbdf8](https://github.com/partcyborg/tanka/commit/1cfbdf83a91494db6bfdc7e5d69451ee73a2dcb7))
* **cli:** TANKA_PAGER environment variable ([#1047](https://github.com/partcyborg/tanka/issues/1047)) ([ce9a47a](https://github.com/partcyborg/tanka/commit/ce9a47af31585e71e94892042fae73716bd8e889))
* **cmd:** add --jsonnet-implemenation flag to `tk eval` ([#998](https://github.com/partcyborg/tanka/issues/998)) ([1975c28](https://github.com/partcyborg/tanka/commit/1975c28e790fc7aa2f40315b2d4795269b9c4574))
* **docker:** add kustomize binary ([#597](https://github.com/partcyborg/tanka/issues/597)) ([ce3e48e](https://github.com/partcyborg/tanka/commit/ce3e48e9a056c540e020506340959f6df037ac24))
* **docker:** fix build and remove arm 32 bit ([#598](https://github.com/partcyborg/tanka/issues/598)) ([c12e4ab](https://github.com/partcyborg/tanka/commit/c12e4ab28281d40db1f91b3060df188cab740e96))
* **env list:** allow specifying a jsonnet implementation ([#1208](https://github.com/partcyborg/tanka/issues/1208)) ([a3e7140](https://github.com/partcyborg/tanka/commit/a3e7140ce3d17c65ec551f27fc4443f00556676a))
* new `tk tool importers-count` ([#1232](https://github.com/partcyborg/tanka/issues/1232)) ([5dcb6c5](https://github.com/partcyborg/tanka/commit/5dcb6c5bb56a704ed806c74d37beede93352415a))
* support --{tla,ext}-{code,str}-file flag in "tk eval" ([#1238](https://github.com/partcyborg/tanka/issues/1238)) ([a93627a](https://github.com/partcyborg/tanka/commit/a93627ab3abb165f3d2323abb277fda5bda1fb46))
* support apply --server-side ([#695](https://github.com/partcyborg/tanka/issues/695)) ([6622006](https://github.com/partcyborg/tanka/commit/6622006dc90abbe45a6967710d94d78919edbd67))


### 🐛 Bug Fixes

* `Unexpected input(s) 'github-token'` in `release-please` job ([#1301](https://github.com/partcyborg/tanka/issues/1301)) ([e465a31](https://github.com/partcyborg/tanka/commit/e465a3123ea9b18f6b3afe4414f7bb80b57efa32))
* **ci:** fix setup-goversion after Dockerfile cleanup ([#1154](https://github.com/partcyborg/tanka/issues/1154)) ([d69d2f2](https://github.com/partcyborg/tanka/commit/d69d2f2f02d9f733ce7ce78503380ce465f18f51))
* close repo tmp file ([#1022](https://github.com/partcyborg/tanka/issues/1022)) ([5e0eb01](https://github.com/partcyborg/tanka/commit/5e0eb011a6de3163e5eead8d0b2f8278d1100b1a))
* delete command supports kinds that do not match singular/plural names ([#1236](https://github.com/partcyborg/tanka/issues/1236)) ([bf702ef](https://github.com/partcyborg/tanka/commit/bf702ef1fb562be8f1e998e0468dd7e178f20cac))
* Do not hide diff error details (kubectl &lt; 1.18.0) ([#1078](https://github.com/partcyborg/tanka/issues/1078)) ([43958b7](https://github.com/partcyborg/tanka/commit/43958b733856f319c17aa16caa590241d09fd18c))
* Do not remove data ([#585](https://github.com/partcyborg/tanka/issues/585)) ([4ea9f6b](https://github.com/partcyborg/tanka/commit/4ea9f6b4f2220cd56409203428912d78ae002e4d))
* **docker:** fix warnings in Dockerfile ([#1153](https://github.com/partcyborg/tanka/issues/1153)) ([386e905](https://github.com/partcyborg/tanka/commit/386e9056cf10fe8b71ad2f8d78e1f7aa58a3fec5))
* **docs:** replace deprecated translation API ([#1181](https://github.com/partcyborg/tanka/issues/1181)) ([edc0541](https://github.com/partcyborg/tanka/commit/edc0541c8b8f0ee254967de768fa82b522e0ebba))
* **docs:** Starlight 0.28.3 introduced some changes to the i18n config ([cb76741](https://github.com/partcyborg/tanka/commit/cb767419bbfc2d2408d5c7125c3424ed55568627))
* **docs:** starlight 0.28.3 introduced some changes to the i18n config ([#1219](https://github.com/partcyborg/tanka/issues/1219)) ([cb76741](https://github.com/partcyborg/tanka/commit/cb767419bbfc2d2408d5c7125c3424ed55568627))
* handle quotes in --tla-str and --ext-str in "tk eval" ([#1237](https://github.com/partcyborg/tanka/issues/1237)) ([7cba21d](https://github.com/partcyborg/tanka/commit/7cba21d3ea83b20f359516b7dc2e91424c8f48da))
* **helm:** Pass multiple --api-versions flags to Helm ([#573](https://github.com/partcyborg/tanka/issues/573)) ([#576](https://github.com/partcyborg/tanka/issues/576)) ([13ab03a](https://github.com/partcyborg/tanka/commit/13ab03abf344a80ed2d1dacfc54c7982606a6849))
* If there's a full match on an inline environment name, use it ([#620](https://github.com/partcyborg/tanka/issues/620)) ([a2b5665](https://github.com/partcyborg/tanka/commit/a2b56654f3cf69df9d2a11a31271ee105a3180fd))
* **kubernetes-client:** Match context & cluster names exactly ([#948](https://github.com/partcyborg/tanka/issues/948)) ([05f71fe](https://github.com/partcyborg/tanka/commit/05f71fe1b606dbcded0e9eb0f97fbc337958adee))
* make export --format respect "/" in template actions ([#572](https://github.com/partcyborg/tanka/issues/572)) ([72d5517](https://github.com/partcyborg/tanka/commit/72d55175c0039e38de243df30a569557191b4da8)), closes [#568](https://github.com/partcyborg/tanka/issues/568)
* mimic --tla-code behavior from jsonnet for functions in main.jsonnet in env discovery ([#1251](https://github.com/partcyborg/tanka/issues/1251)) ([3065778](https://github.com/partcyborg/tanka/commit/3065778d03f9cecb4896fc0275af510c836e991d))
* prevent concurrent writes in `env list` command ([#1182](https://github.com/partcyborg/tanka/issues/1182)) ([5a3581d](https://github.com/partcyborg/tanka/commit/5a3581d4625fd5bc08b292b8167e4edcc98e5d52))
* Remove unnecessary print statement ([f0b1082](https://github.com/partcyborg/tanka/commit/f0b1082d7712239b0855e8c50265d35582c1878a))
* remove unnecessary print statement ([#1151](https://github.com/partcyborg/tanka/issues/1151)) ([f0b1082](https://github.com/partcyborg/tanka/commit/f0b1082d7712239b0855e8c50265d35582c1878a))
* Replace godirwalk with filepath.WalkDir ([aac92fd](https://github.com/partcyborg/tanka/commit/aac92fdc4e63698af40f10d3c582afd78f48bae5))
* replace godirwalk with filepath.WalkDir ([#1058](https://github.com/partcyborg/tanka/issues/1058)) ([aac92fd](https://github.com/partcyborg/tanka/commit/aac92fdc4e63698af40f10d3c582afd78f48bae5))
* Use generateName as last comparison when sorting ([#1031](https://github.com/partcyborg/tanka/issues/1031)) ([63cfe63](https://github.com/partcyborg/tanka/commit/63cfe6313c236fe2fc65d86f831e4624eaafc6a6))


### 📝 Documentation

* "envirnoments" typo ([#1080](https://github.com/partcyborg/tanka/issues/1080)) ([2b2324d](https://github.com/partcyborg/tanka/commit/2b2324db3a00cf28772b477a9d2a6d094c89629e))
* Add .nojekyll file to output ([#1027](https://github.com/partcyborg/tanka/issues/1027)) ([879ceb5](https://github.com/partcyborg/tanka/commit/879ceb5d8327de435715549c2b790657ce2b9dcc))
* Add chmod to install instructions ([#724](https://github.com/partcyborg/tanka/issues/724)) ([cfe9627](https://github.com/partcyborg/tanka/commit/cfe9627dcab2321746e5cd2eeb05a6b54a674432))
* add instructions for releasing a new version ([#1120](https://github.com/partcyborg/tanka/issues/1120)) ([c5180bf](https://github.com/partcyborg/tanka/commit/c5180bff80493da1586fc0d05117a5cfde5effa0))
* Fix broken links and redirects ([#739](https://github.com/partcyborg/tanka/issues/739)) ([172a56f](https://github.com/partcyborg/tanka/commit/172a56f99b482f78f9ce1236279b86d95e022676))
* fix helm example ([#1037](https://github.com/partcyborg/tanka/issues/1037)) ([a30ac95](https://github.com/partcyborg/tanka/commit/a30ac953daef0e4d69433ab2825a54f79c94a159))
* new docs website using Astro + Starlight ([#1025](https://github.com/partcyborg/tanka/issues/1025)) ([49c9b07](https://github.com/partcyborg/tanka/commit/49c9b07b99b8cc30df2a759aa7858afccbd93e8f))
* remove mailinglists from the README ([#1183](https://github.com/partcyborg/tanka/issues/1183)) ([c6557bb](https://github.com/partcyborg/tanka/commit/c6557bb29c04ae9cd480b1add4467ffbd9e7eb00))
* remove statement about importing YAML files ([#1127](https://github.com/partcyborg/tanka/issues/1127)) ([e37bfdf](https://github.com/partcyborg/tanka/commit/e37bfdf264d538c444743669dc83342594f9368a))
* rework tutorial to not use global $ ([#1046](https://github.com/partcyborg/tanka/issues/1046)) ([f4103b5](https://github.com/partcyborg/tanka/commit/f4103b535f93209128033dcf6f0287676dd741a5))
* update override method for tanka ([#804](https://github.com/partcyborg/tanka/issues/804)) ([93b1585](https://github.com/partcyborg/tanka/commit/93b1585eb7a2a3a7da5f5fb794299eff0b090c3d))


### 🏗️ Build System

* **deps-dev:** bump prettier from 3.3.0 to 3.3.1 in /docs ([#1063](https://github.com/partcyborg/tanka/issues/1063)) ([83c3589](https://github.com/partcyborg/tanka/commit/83c358998cf995d4a4bf89494433aff290741417))
* **deps-dev:** bump prettier from 3.3.1 to 3.3.2 in /docs ([#1069](https://github.com/partcyborg/tanka/issues/1069)) ([3719a63](https://github.com/partcyborg/tanka/commit/3719a632e4c26d05735f316ee0af850460f366b1))
* **deps:** bump @astrojs/starlight from 0.22.3 to 0.23.2 in /docs ([#1049](https://github.com/partcyborg/tanka/issues/1049)) ([6def867](https://github.com/partcyborg/tanka/commit/6def8678b84bdedca951d8d0b23eb7fab0f9f5ff))
* **deps:** bump @astrojs/starlight from 0.23.2 to 0.24.1 in /docs ([#1061](https://github.com/partcyborg/tanka/issues/1061)) ([8eff4c7](https://github.com/partcyborg/tanka/commit/8eff4c761ea1595b6df95adf65953da19579d81e))
* **deps:** bump @astrojs/starlight from 0.24.1 to 0.24.3 in /docs ([#1071](https://github.com/partcyborg/tanka/issues/1071)) ([de68afe](https://github.com/partcyborg/tanka/commit/de68afebb6d2e9b187310001a3c0bd92f13a2d70))
* **deps:** bump @astrojs/starlight from 0.24.3 to 0.24.4 in /docs ([#1073](https://github.com/partcyborg/tanka/issues/1073)) ([9181c1a](https://github.com/partcyborg/tanka/commit/9181c1a78e4bc99067f6b0cd0a907b503429f0f0))
* **deps:** bump @astrojs/starlight from 0.24.4 to 0.24.5 in /docs ([#1082](https://github.com/partcyborg/tanka/issues/1082)) ([f83381a](https://github.com/partcyborg/tanka/commit/f83381adc30454654e6aa440af3639c6f8d212e0))
* **deps:** bump acceptance-tests-dependencies group in /acceptance-tests with 2 updates ([#1216](https://github.com/partcyborg/tanka/issues/1216)) ([28f3cbf](https://github.com/partcyborg/tanka/commit/28f3cbf76063914b9681017b1ce304f1fac12f80))
* **deps:** bump actions/cache from 4.0.2 to 4.1.0 ([#1184](https://github.com/partcyborg/tanka/issues/1184)) ([e5231d7](https://github.com/partcyborg/tanka/commit/e5231d76cb779f8af0e7072ba10dec9088426ac4))
* **deps:** bump actions/cache from 4.1.0 to 4.1.1 ([#1199](https://github.com/partcyborg/tanka/issues/1199)) ([37cb6e8](https://github.com/partcyborg/tanka/commit/37cb6e8c90a3c8597ab3bd291a17043bd51f6487))
* **deps:** bump actions/cache from 4.1.1 to 4.1.2 ([#1209](https://github.com/partcyborg/tanka/issues/1209)) ([b40b371](https://github.com/partcyborg/tanka/commit/b40b371d3678280d0a1b312ccd5c4de03d2bc50f))
* **deps:** bump actions/cache from 4.1.2 to 4.2.0 ([#1267](https://github.com/partcyborg/tanka/issues/1267)) ([c3f9ceb](https://github.com/partcyborg/tanka/commit/c3f9ceb35dd22056302a24c0460bd10da4ba932f))
* **deps:** bump actions/cache from 4.2.0 to 4.2.1 ([#1362](https://github.com/partcyborg/tanka/issues/1362)) ([210ee51](https://github.com/partcyborg/tanka/commit/210ee5194b69e4373fa99893422a7b7029aec871))
* **deps:** bump actions/cache from 4.2.1 to 4.2.2 ([#1371](https://github.com/partcyborg/tanka/issues/1371)) ([fbfa04f](https://github.com/partcyborg/tanka/commit/fbfa04fd4ce43c9526a120d82fc7f14ab21fcec3))
* **deps:** bump actions/checkout from 4.1.7 to 4.2.0 ([#1177](https://github.com/partcyborg/tanka/issues/1177)) ([4bf5238](https://github.com/partcyborg/tanka/commit/4bf5238637d1272f385b3481ec943772528fcdc0))
* **deps:** bump actions/checkout from 4.2.0 to 4.2.1 ([#1200](https://github.com/partcyborg/tanka/issues/1200)) ([a5d960f](https://github.com/partcyborg/tanka/commit/a5d960f926005da44445de557d7863bb53a4c6e2))
* **deps:** bump actions/checkout from 4.2.0 to 4.2.2 ([#1233](https://github.com/partcyborg/tanka/issues/1233)) ([cb5d0c8](https://github.com/partcyborg/tanka/commit/cb5d0c8cafc0d7b855e4210f0e64a205e3cec163))
* **deps:** bump actions/checkout from 4.2.1 to 4.2.2 ([#1210](https://github.com/partcyborg/tanka/issues/1210)) ([bc0078e](https://github.com/partcyborg/tanka/commit/bc0078ecd23848a855c4438f8c4f9933b163ade5))
* **deps:** bump actions/create-github-app-token from 1.11.0 to 1.11.1 ([#1323](https://github.com/partcyborg/tanka/issues/1323)) ([be354cc](https://github.com/partcyborg/tanka/commit/be354cca593e07d17f32262ae7b81ffb6690a5c4))
* **deps:** bump actions/create-github-app-token from 1.11.1 to 1.11.2 ([#1330](https://github.com/partcyborg/tanka/issues/1330)) ([0e930c6](https://github.com/partcyborg/tanka/commit/0e930c6432ba97687d7d5e6e36825d5d76239acf))
* **deps:** bump actions/create-github-app-token from 1.11.2 to 1.11.3 ([#1341](https://github.com/partcyborg/tanka/issues/1341)) ([aa5d4d1](https://github.com/partcyborg/tanka/commit/aa5d4d180d704fc008c0f37fefdedc446118c697))
* **deps:** bump actions/create-github-app-token from 1.11.3 to 1.11.5 ([#1355](https://github.com/partcyborg/tanka/issues/1355)) ([06b3df4](https://github.com/partcyborg/tanka/commit/06b3df46e6ec4cc36138e527acb2b03498fd06e3))
* **deps:** bump actions/create-github-app-token from 1.11.5 to 1.11.6 ([#1370](https://github.com/partcyborg/tanka/issues/1370)) ([e3e6046](https://github.com/partcyborg/tanka/commit/e3e60468e9eed82f52e265f948a5a0bc06b49c8b))
* **deps:** bump actions/setup-node from 4.0.3 to 4.0.4 ([#1171](https://github.com/partcyborg/tanka/issues/1171)) ([19b1ac0](https://github.com/partcyborg/tanka/commit/19b1ac0a803aaa94ab84fa01d2f066f34d3de47a))
* **deps:** bump actions/setup-node from 4.0.4 to 4.1.0 ([#1212](https://github.com/partcyborg/tanka/issues/1212)) ([8aa8445](https://github.com/partcyborg/tanka/commit/8aa84454b7e66115faa05c7d6e12d96b76526ce7))
* **deps:** bump actions/setup-node from 4.1.0 to 4.2.0 ([#1321](https://github.com/partcyborg/tanka/issues/1321)) ([1067607](https://github.com/partcyborg/tanka/commit/106760704673bf8e8a61e64e3b08120677251d65))
* **deps:** bump actions/upload-artifact from 4.3.4 to 4.3.5 ([#1123](https://github.com/partcyborg/tanka/issues/1123)) ([d931860](https://github.com/partcyborg/tanka/commit/d9318601dfbefd9edcc23b1c9a962de36ae32c56))
* **deps:** bump actions/upload-artifact from 4.3.5 to 4.3.6 ([#1130](https://github.com/partcyborg/tanka/issues/1130)) ([8a8b16c](https://github.com/partcyborg/tanka/commit/8a8b16c55b1a64edb394c018900f1bde6a2cd2c1))
* **deps:** bump actions/upload-artifact from 4.3.6 to 4.4.0 ([#1148](https://github.com/partcyborg/tanka/issues/1148)) ([575b0a0](https://github.com/partcyborg/tanka/commit/575b0a07d04b7c680be064396d095e0e0e7fcdb8))
* **deps:** bump actions/upload-artifact from 4.4.0 to 4.4.3 ([#1198](https://github.com/partcyborg/tanka/issues/1198)) ([3342249](https://github.com/partcyborg/tanka/commit/33422490126c1467af9530d90209fffe28294233))
* **deps:** bump actions/upload-artifact from 4.4.3 to 4.6.0 ([#1315](https://github.com/partcyborg/tanka/issues/1315)) ([bb482d9](https://github.com/partcyborg/tanka/commit/bb482d927062d2fe0f5a53b482dd36353c50520b))
* **deps:** bump actions/upload-artifact from 4.6.0 to 4.6.1 ([#1360](https://github.com/partcyborg/tanka/issues/1360)) ([cc3c4a3](https://github.com/partcyborg/tanka/commit/cc3c4a3b66f79f1e33f32c8252ddfb359dd5431f))
* **deps:** bump alpine from 3.20 to 3.21 ([#1265](https://github.com/partcyborg/tanka/issues/1265)) ([b9f4911](https://github.com/partcyborg/tanka/commit/b9f49116b87764636f4fa26aa29f786f9a83bbef))
* **deps:** bump astro from 4.10.1 to 4.10.2 in /docs ([#1068](https://github.com/partcyborg/tanka/issues/1068)) ([627fd75](https://github.com/partcyborg/tanka/commit/627fd758eb62fbd12fe599c75ae7b499f4c2bddf))
* **deps:** bump astro from 4.10.2 to 4.11.2 in /docs ([#1079](https://github.com/partcyborg/tanka/issues/1079)) ([6cd0a47](https://github.com/partcyborg/tanka/commit/6cd0a4719e98a9d8613506e87b1fea132da05be8))
* **deps:** bump astro from 4.11.2 to 4.11.3 in /docs ([#1083](https://github.com/partcyborg/tanka/issues/1083)) ([b8930a5](https://github.com/partcyborg/tanka/commit/b8930a55fd8c5e08bf9a284e2f75463d43ace3e1))
* **deps:** bump astro from 4.15.11 to 4.16.1 in /docs ([#1203](https://github.com/partcyborg/tanka/issues/1203)) ([858c419](https://github.com/partcyborg/tanka/commit/858c419dbf65e7fea9ccf58c2329d77ed009f223))
* **deps:** bump astro from 4.8.4 to 4.9.2 in /docs ([#1053](https://github.com/partcyborg/tanka/issues/1053)) ([160cf2f](https://github.com/partcyborg/tanka/commit/160cf2f3383c12e64796be43876c4a8ea9b1cf5a))
* **deps:** bump astro from 4.9.2 to 4.10.1 in /docs ([#1062](https://github.com/partcyborg/tanka/issues/1062)) ([2cb2e37](https://github.com/partcyborg/tanka/commit/2cb2e37de1dbbaf8f11a4ae6afa3664c19fec36e))
* **deps:** bump astro from 5.0.5 to 5.0.8 in /docs ([#1293](https://github.com/partcyborg/tanka/issues/1293)) ([060d5e8](https://github.com/partcyborg/tanka/commit/060d5e88b733b3792e23fa98945d3c82451450ac))
* **deps:** bump astro from 5.1.1 to 5.1.2 in /docs in the docs-dependencies group ([#1303](https://github.com/partcyborg/tanka/issues/1303)) ([27991f4](https://github.com/partcyborg/tanka/commit/27991f4c9cfab28bf366e6c3991bbfa12dac374e))
* **deps:** bump astro from 5.1.7 to 5.1.10 in /docs ([#1328](https://github.com/partcyborg/tanka/issues/1328)) ([e75bbf8](https://github.com/partcyborg/tanka/commit/e75bbf888c4fcfe1fb933fc60e947c35b3dca603))
* **deps:** bump azure/setup-helm from 4.2.0 to 4.3.0 ([#1361](https://github.com/partcyborg/tanka/issues/1361)) ([2f870c2](https://github.com/partcyborg/tanka/commit/2f870c20494727f13b79baa496bda6d9479087fd))
* **deps:** bump dagger/dagger-for-github from 5.11.0 to 6.0.0 ([#1103](https://github.com/partcyborg/tanka/issues/1103)) ([545dde4](https://github.com/partcyborg/tanka/commit/545dde4513b8ad361905e7e3ef32be34068d543f))
* **deps:** bump dagger/dagger-for-github from 5.6.0 to 5.11.0 ([#1081](https://github.com/partcyborg/tanka/issues/1081)) ([6f61556](https://github.com/partcyborg/tanka/commit/6f61556b39cc13288299d56769a02f4165ba1cd9))
* **deps:** bump dagger/dagger-for-github from 6.0.0 to 6.1.0 ([#1107](https://github.com/partcyborg/tanka/issues/1107)) ([77c88eb](https://github.com/partcyborg/tanka/commit/77c88ebb464020c8bd85706dbdbafe048c347498))
* **deps:** bump dagger/dagger-for-github from 6.1.0 to 6.3.0 ([#1114](https://github.com/partcyborg/tanka/issues/1114)) ([d1e7d18](https://github.com/partcyborg/tanka/commit/d1e7d18c7ff9c1287b663f58b67ad1f315e7ad2f))
* **deps:** bump dagger/dagger-for-github from 6.11.0 to 6.13.0 ([#1197](https://github.com/partcyborg/tanka/issues/1197)) ([2b5e99d](https://github.com/partcyborg/tanka/commit/2b5e99db4ba48746dd287a71460cecec0451465d))
* **deps:** bump dagger/dagger-for-github from 6.13.0 to 6.14.0 ([#1211](https://github.com/partcyborg/tanka/issues/1211)) ([efcaa43](https://github.com/partcyborg/tanka/commit/efcaa43e4ce435e974b11ac4faee10abe46bf5a0))
* **deps:** bump dagger/dagger-for-github from 6.14.0 to 7.0.1 ([#1224](https://github.com/partcyborg/tanka/issues/1224)) ([932e7ce](https://github.com/partcyborg/tanka/commit/932e7ceecf85aa15b9f855eec47d62c4e8cd254f))
* **deps:** bump dagger/dagger-for-github from 6.3.0 to 6.4.0 ([#1124](https://github.com/partcyborg/tanka/issues/1124)) ([6df254d](https://github.com/partcyborg/tanka/commit/6df254d779b76557c5fbc2d36932e3c0617bf11a))
* **deps:** bump dagger/dagger-for-github from 6.4.0 to 6.5.0 ([#1138](https://github.com/partcyborg/tanka/issues/1138)) ([3b71cdc](https://github.com/partcyborg/tanka/commit/3b71cdceab2aa85a9e8f8ead7f94ec2452138891))
* **deps:** bump dagger/dagger-for-github from 6.5.0 to 6.7.0 ([#1152](https://github.com/partcyborg/tanka/issues/1152)) ([b25e963](https://github.com/partcyborg/tanka/commit/b25e96376ee1fa38e8e67a8b4c87d304c461cbb9))
* **deps:** bump dagger/dagger-for-github from 6.7.0 to 6.8.0 ([#1164](https://github.com/partcyborg/tanka/issues/1164)) ([5bf2aa5](https://github.com/partcyborg/tanka/commit/5bf2aa5556c790de65e6401eb9ab1b95260500bb))
* **deps:** bump dagger/dagger-for-github from 6.8.0 to 6.11.0 ([#1170](https://github.com/partcyborg/tanka/issues/1170)) ([f2f6ca9](https://github.com/partcyborg/tanka/commit/f2f6ca9b92527614c2e37b4dbaff7da904b3f653))
* **deps:** bump dagger/dagger-for-github from 7.0.1 to 7.0.3 ([#1285](https://github.com/partcyborg/tanka/issues/1285)) ([a5ec928](https://github.com/partcyborg/tanka/commit/a5ec928aa7b793b67f7f6599fbb23e977ca90327))
* **deps:** bump dagger/dagger-for-github from 7.0.3 to 7.0.4 ([#1314](https://github.com/partcyborg/tanka/issues/1314)) ([e7acea4](https://github.com/partcyborg/tanka/commit/e7acea427c7fb4441e5796c0530a337c6f6e7b6e))
* **deps:** bump dagger/dagger-for-github from 7.0.4 to 7.0.5 ([#1340](https://github.com/partcyborg/tanka/issues/1340)) ([5645dfd](https://github.com/partcyborg/tanka/commit/5645dfdf23d929fbc73b62205dcbbf832832dadb))
* **deps:** bump dagger/dagger-for-github from 7.0.5 to 7.0.6 ([#1356](https://github.com/partcyborg/tanka/issues/1356)) ([816fc4b](https://github.com/partcyborg/tanka/commit/816fc4b1e4f2ab77f83bdffe920e16c98e7e8b59))
* **deps:** bump docker/build-push-action from 5 to 6 ([#1075](https://github.com/partcyborg/tanka/issues/1075)) ([9766726](https://github.com/partcyborg/tanka/commit/9766726f55484949349955478d6b06113f01ed80))
* **deps:** bump docker/build-push-action from 6.10.0 to 6.13.0 ([#1320](https://github.com/partcyborg/tanka/issues/1320)) ([fb3d545](https://github.com/partcyborg/tanka/commit/fb3d545762daa11bd0fdd8874a8b410eda674f79))
* **deps:** bump docker/build-push-action from 6.13.0 to 6.14.0 ([#1363](https://github.com/partcyborg/tanka/issues/1363)) ([a71fd1b](https://github.com/partcyborg/tanka/commit/a71fd1b71ef882d6e2769886360bbcb73fb6baf0))
* **deps:** bump docker/build-push-action from 6.5.0 to 6.7.0 ([#1139](https://github.com/partcyborg/tanka/issues/1139)) ([4fa9d9e](https://github.com/partcyborg/tanka/commit/4fa9d9ee365362d284f1f448ee22e302b6928ada))
* **deps:** bump docker/build-push-action from 6.7.0 to 6.8.0 ([#1178](https://github.com/partcyborg/tanka/issues/1178)) ([e8b727f](https://github.com/partcyborg/tanka/commit/e8b727f46f21392d76335f54c2569a15a3927bec))
* **deps:** bump docker/build-push-action from 6.8.0 to 6.9.0 ([#1186](https://github.com/partcyborg/tanka/issues/1186)) ([c04a553](https://github.com/partcyborg/tanka/commit/c04a553e2eb7e13dfa6b927ba7bb5c8dc0ac0388))
* **deps:** bump docker/build-push-action from 6.9.0 to 6.10.0 ([#1255](https://github.com/partcyborg/tanka/issues/1255)) ([2118b15](https://github.com/partcyborg/tanka/commit/2118b153ed24ae5440c89fa552a5430d2f6741df))
* **deps:** bump docker/metadata-action from 5.5.1 to 5.6.1 ([#1245](https://github.com/partcyborg/tanka/issues/1245)) ([e16af88](https://github.com/partcyborg/tanka/commit/e16af885811ec4302fbce34223529f4907357dd0))
* **deps:** bump docker/setup-buildx-action from 3.5.0 to 3.6.1 ([#1125](https://github.com/partcyborg/tanka/issues/1125)) ([0ba5e9a](https://github.com/partcyborg/tanka/commit/0ba5e9ad8e2cdaddca8c196a126d7bb373b95813))
* **deps:** bump docker/setup-buildx-action from 3.6.1 to 3.7.1 ([#1185](https://github.com/partcyborg/tanka/issues/1185)) ([9f2419a](https://github.com/partcyborg/tanka/commit/9f2419adc532441dbb16acfea4a4fcc89019b1ae))
* **deps:** bump docker/setup-buildx-action from 3.7.1 to 3.8.0 ([#1332](https://github.com/partcyborg/tanka/issues/1332)) ([b6ffaa9](https://github.com/partcyborg/tanka/commit/b6ffaa9f151e211ec8051a906bc51998a1d111a6))
* **deps:** bump docker/setup-buildx-action from 3.8.0 to 3.9.0 ([#1343](https://github.com/partcyborg/tanka/issues/1343)) ([65c0b67](https://github.com/partcyborg/tanka/commit/65c0b67c1361715088ca4055d19e0bae56a074e0))
* **deps:** bump github.com/99designs/gqlgen from 0.17.56 to 0.17.57 in /dagger ([#1244](https://github.com/partcyborg/tanka/issues/1244)) ([c03cb00](https://github.com/partcyborg/tanka/commit/c03cb0098c1079f72ae56d5a69cf3160c5bdef48))
* **deps:** bump github.com/99designs/gqlgen from 0.17.57 to 0.17.60 in /dagger ([#1276](https://github.com/partcyborg/tanka/issues/1276)) ([71defaa](https://github.com/partcyborg/tanka/commit/71defaa3eeb0a836b5d6944fd5aaebb081489123))
* **deps:** bump github.com/99designs/gqlgen from 0.17.61 to 0.17.62 in /dagger ([#1302](https://github.com/partcyborg/tanka/issues/1302)) ([59b78ed](https://github.com/partcyborg/tanka/commit/59b78ed994966256025b69b381c3376e5acc3ac6))
* **deps:** bump github.com/99designs/gqlgen from 0.17.64 to 0.17.66 ([#1353](https://github.com/partcyborg/tanka/issues/1353)) ([e0ad1a5](https://github.com/partcyborg/tanka/commit/e0ad1a5fa404789ed7c6ba23527becf56e05fcab))
* **deps:** bump github.com/fatih/color from 1.17.0 to 1.18.0 ([#1213](https://github.com/partcyborg/tanka/issues/1213)) ([5bbfea1](https://github.com/partcyborg/tanka/commit/5bbfea1c33b1159d5b607c40e597f0ab825a36fe))
* **deps:** bump github.com/google/go-cmp from 0.6.0 to 0.7.0 ([#1364](https://github.com/partcyborg/tanka/issues/1364)) ([5daa8a8](https://github.com/partcyborg/tanka/commit/5daa8a841bb6f87980a0fbdfb624e11c3a1fc5dd))
* **deps:** bump github.com/Masterminds/sprig/v3 from 3.2.3 to 3.3.0 ([#1146](https://github.com/partcyborg/tanka/issues/1146)) ([4917824](https://github.com/partcyborg/tanka/commit/4917824a3204378bceda12b73545c782a08dd7a5))
* **deps:** bump github.com/spf13/pflag from 1.0.5 to 1.0.6 ([#1333](https://github.com/partcyborg/tanka/issues/1333)) ([64c51f9](https://github.com/partcyborg/tanka/commit/64c51f996ec8ac41ce0a627b337eebc98dc9f654))
* **deps:** bump github.com/stretchr/testify from 1.9.0 to 1.10.0 ([#1243](https://github.com/partcyborg/tanka/issues/1243)) ([ec8ec69](https://github.com/partcyborg/tanka/commit/ec8ec690057666ee6aeef8d67236d0e9e450d44f))
* **deps:** bump github.com/vektah/gqlparser/v2 from 2.5.16 to 2.5.17 in /dagger ([#1179](https://github.com/partcyborg/tanka/issues/1179)) ([ca2490b](https://github.com/partcyborg/tanka/commit/ca2490b11ca65e2c816e08cd84305b84bc6e39fa))
* **deps:** bump github.com/vektah/gqlparser/v2 from 2.5.17 to 2.5.18 in /dagger ([#1206](https://github.com/partcyborg/tanka/issues/1206)) ([f6cc319](https://github.com/partcyborg/tanka/commit/f6cc3198f5466a2bcbe14c8c181fada4d5d90895))
* **deps:** bump github.com/vektah/gqlparser/v2 from 2.5.19 to 2.5.20 ([#1253](https://github.com/partcyborg/tanka/issues/1253)) ([9b531c9](https://github.com/partcyborg/tanka/commit/9b531c96c095038593765af187bc8230f6d45a70))
* **deps:** bump github.com/vektah/gqlparser/v2 from 2.5.22 to 2.5.23 ([#1372](https://github.com/partcyborg/tanka/issues/1372)) ([bc3e6d1](https://github.com/partcyborg/tanka/commit/bc3e6d183a0b35c878def9b89ab812de173ca9f9))
* **deps:** bump golang from 1.22.3 to 1.22.4 ([#1060](https://github.com/partcyborg/tanka/issues/1060)) ([3f5e064](https://github.com/partcyborg/tanka/commit/3f5e0647aa22131cd683bb409afb7e083d582211))
* **deps:** bump golang from 1.22.4 to 1.22.5 ([#1101](https://github.com/partcyborg/tanka/issues/1101)) ([5a6871c](https://github.com/partcyborg/tanka/commit/5a6871c5fc085b70359a817ee1e388e289c0318a))
* **deps:** bump golang from 1.22.5 to 1.23.0 ([#1140](https://github.com/partcyborg/tanka/issues/1140)) ([65594a1](https://github.com/partcyborg/tanka/commit/65594a121dad227c0e1064dafb328992bb0442f6))
* **deps:** bump golang from 1.23.0 to 1.23.1 ([#1161](https://github.com/partcyborg/tanka/issues/1161)) ([2dc1b3a](https://github.com/partcyborg/tanka/commit/2dc1b3ac4bf647f5df57fe1f13aa2946c48592c3))
* **deps:** bump golang from 1.23.1 to 1.23.2 ([#1188](https://github.com/partcyborg/tanka/issues/1188)) ([816414b](https://github.com/partcyborg/tanka/commit/816414b11fb80a94c50289f3f21accc78a1f6e1f))
* **deps:** bump golang from 1.23.2 to 1.23.3 ([#1227](https://github.com/partcyborg/tanka/issues/1227)) ([576bfe5](https://github.com/partcyborg/tanka/commit/576bfe561c39c783cfe6e1b92918d5483954a060))
* **deps:** bump golang from 1.23.3 to 1.23.4 ([#1266](https://github.com/partcyborg/tanka/issues/1266)) ([7f18b87](https://github.com/partcyborg/tanka/commit/7f18b87f291dfa6d7e6c8d12f63024f394637e0c))
* **deps:** bump golang from 1.23.4 to 1.23.5 ([#1312](https://github.com/partcyborg/tanka/issues/1312)) ([d6e7417](https://github.com/partcyborg/tanka/commit/d6e74172984dfb268e887ccb94d8f68c0c50dc49))
* **deps:** bump golang from 1.23.5 to 1.23.6 ([#1344](https://github.com/partcyborg/tanka/issues/1344)) ([04acba0](https://github.com/partcyborg/tanka/commit/04acba05c14923044fb335bbb82ac09cccd6efb1))
* **deps:** bump golang from 1.23.6 to 1.24.0 ([#1350](https://github.com/partcyborg/tanka/issues/1350)) ([65c8b12](https://github.com/partcyborg/tanka/commit/65c8b1277b6ef9fb87a006c2478051e33121cc41))
* **deps:** bump golang.org/x/crypto from 0.26.0 to 0.31.0 ([#1284](https://github.com/partcyborg/tanka/issues/1284)) ([6885695](https://github.com/partcyborg/tanka/commit/68856959a6abc32d5d0a28f9f9879fb32632d553))
* **deps:** bump golang.org/x/sync from 0.10.0 to 0.11.0 in the dagger-dependencies group ([#1346](https://github.com/partcyborg/tanka/issues/1346)) ([b0938b8](https://github.com/partcyborg/tanka/commit/b0938b82f38d639110708b05dc820df9525191db))
* **deps:** bump golang.org/x/sync from 0.7.0 to 0.8.0 in /dagger in the dagger-dependencies group ([#1126](https://github.com/partcyborg/tanka/issues/1126)) ([915adfe](https://github.com/partcyborg/tanka/commit/915adfe94d7e113ba316c9e29eeab816ddfc4a5a))
* **deps:** bump golang.org/x/term from 0.20.0 to 0.21.0 ([#1066](https://github.com/partcyborg/tanka/issues/1066)) ([ca43789](https://github.com/partcyborg/tanka/commit/ca4378913a15dc9207e18c7e8bb737201ee21f56))
* **deps:** bump golang.org/x/term from 0.21.0 to 0.22.0 ([#1100](https://github.com/partcyborg/tanka/issues/1100)) ([7cd5f8e](https://github.com/partcyborg/tanka/commit/7cd5f8e4abcda06a5b112fcba4004b3e7263e9c7))
* **deps:** bump golang.org/x/term from 0.22.0 to 0.23.0 ([#1134](https://github.com/partcyborg/tanka/issues/1134)) ([98273c8](https://github.com/partcyborg/tanka/commit/98273c8f7bea144828bc054267086d455ff416db))
* **deps:** bump golang.org/x/term from 0.23.0 to 0.24.0 ([#1159](https://github.com/partcyborg/tanka/issues/1159)) ([f34799a](https://github.com/partcyborg/tanka/commit/f34799ab4746f8dd00729b075d87c61955a71eeb))
* **deps:** bump golang.org/x/term from 0.24.0 to 0.25.0 ([#1189](https://github.com/partcyborg/tanka/issues/1189)) ([690e02e](https://github.com/partcyborg/tanka/commit/690e02e2ca8816ec80e4fef468cee1882ace1e30))
* **deps:** bump golang.org/x/term from 0.25.0 to 0.26.0 ([#1223](https://github.com/partcyborg/tanka/issues/1223)) ([70d96f8](https://github.com/partcyborg/tanka/commit/70d96f8c1590563aa33a9ce054d484f22e150cc5))
* **deps:** bump golang.org/x/term from 0.26.0 to 0.27.0 ([#1264](https://github.com/partcyborg/tanka/issues/1264)) ([dc946ad](https://github.com/partcyborg/tanka/commit/dc946ad3228c31d33efa16e7f3aaa80de0569557))
* **deps:** bump golang.org/x/term from 0.27.0 to 0.28.0 ([#1304](https://github.com/partcyborg/tanka/issues/1304)) ([c071693](https://github.com/partcyborg/tanka/commit/c071693977b19aa35d05179f33313426f4c88ce2))
* **deps:** bump golang.org/x/term from 0.28.0 to 0.29.0 ([#1337](https://github.com/partcyborg/tanka/issues/1337)) ([7357261](https://github.com/partcyborg/tanka/commit/73572618605a9b4fc976524c5fab3be9f288fb15))
* **deps:** bump golang.org/x/text from 0.15.0 to 0.16.0 ([#1065](https://github.com/partcyborg/tanka/issues/1065)) ([1cd503c](https://github.com/partcyborg/tanka/commit/1cd503c78d786f77b68e2457fdfbe3b2ef6a0995))
* **deps:** bump golang.org/x/text from 0.16.0 to 0.17.0 ([#1135](https://github.com/partcyborg/tanka/issues/1135)) ([c806bf4](https://github.com/partcyborg/tanka/commit/c806bf4708e0ca32b268f97369c68736ffdc0d02))
* **deps:** bump golang.org/x/text from 0.17.0 to 0.18.0 ([#1160](https://github.com/partcyborg/tanka/issues/1160)) ([c835977](https://github.com/partcyborg/tanka/commit/c8359774210eeded8c328065bc4286753973e1f5))
* **deps:** bump golang.org/x/text from 0.18.0 to 0.19.0 ([#1190](https://github.com/partcyborg/tanka/issues/1190)) ([3838e3c](https://github.com/partcyborg/tanka/commit/3838e3cdf0b86703fe48e97c2a06005d3314aa09))
* **deps:** bump golang.org/x/text from 0.19.0 to 0.20.0 ([#1222](https://github.com/partcyborg/tanka/issues/1222)) ([b8119ad](https://github.com/partcyborg/tanka/commit/b8119adc6a5a893d755e01653682dc7bec754f32))
* **deps:** bump golang.org/x/text from 0.20.0 to 0.21.0 ([#1263](https://github.com/partcyborg/tanka/issues/1263)) ([95258f7](https://github.com/partcyborg/tanka/commit/95258f75ee28c4defcc8c759af2231db807fdac5))
* **deps:** bump golang.org/x/text from 0.21.0 to 0.22.0 ([#1338](https://github.com/partcyborg/tanka/issues/1338)) ([bf90b60](https://github.com/partcyborg/tanka/commit/bf90b601b41474317d42bb916f2fe5f46116c734))
* **deps:** bump google.golang.org/grpc from 1.69.4 to 1.70.0 ([#1326](https://github.com/partcyborg/tanka/issues/1326)) ([d349a7a](https://github.com/partcyborg/tanka/commit/d349a7a8437db9fa696127a290b70d4430d2cbed))
* **deps:** bump JamesIves/github-pages-deploy-action from 4.6.3 to 4.6.4 ([#1158](https://github.com/partcyborg/tanka/issues/1158)) ([232e118](https://github.com/partcyborg/tanka/commit/232e1180cb48fab99bf34449b439606602f74321))
* **deps:** bump JamesIves/github-pages-deploy-action from 4.6.4 to 4.6.8 ([#1176](https://github.com/partcyborg/tanka/issues/1176)) ([1bc883a](https://github.com/partcyborg/tanka/commit/1bc883a57986ee8b3bf35347d830ebb56292f940))
* **deps:** bump JamesIves/github-pages-deploy-action from 4.6.8 to 4.6.9 ([#1225](https://github.com/partcyborg/tanka/issues/1225)) ([e754340](https://github.com/partcyborg/tanka/commit/e754340c4fc6a8ed7b0f12830b1b573bf591f9b4))
* **deps:** bump JamesIves/github-pages-deploy-action from 4.6.9 to 4.7.1 ([#1256](https://github.com/partcyborg/tanka/issues/1256)) ([b3dc764](https://github.com/partcyborg/tanka/commit/b3dc7645e9ac136a4dc0e270ecb2f2af9978fb99))
* **deps:** bump JamesIves/github-pages-deploy-action from 4.7.1 to 4.7.2 ([#1269](https://github.com/partcyborg/tanka/issues/1269)) ([5b59c97](https://github.com/partcyborg/tanka/commit/5b59c9758bab3a26cdf21c6afd0a3b3bfd81a8a9))
* **deps:** bump JamesIves/github-pages-deploy-action from 4.7.2 to 4.7.3 ([#1367](https://github.com/partcyborg/tanka/issues/1367)) ([8fc36b6](https://github.com/partcyborg/tanka/commit/8fc36b6d2f678b04dc68d8be8c3b32286733bd34))
* **deps:** bump k8s.io/apimachinery from 0.28.3 to 0.30.2 ([#1070](https://github.com/partcyborg/tanka/issues/1070)) ([1de4aa3](https://github.com/partcyborg/tanka/commit/1de4aa3de2d5c4caa39e83133ee133782d82df38))
* **deps:** bump k8s.io/apimachinery from 0.30.2 to 0.30.3 ([#1110](https://github.com/partcyborg/tanka/issues/1110)) ([55d9dab](https://github.com/partcyborg/tanka/commit/55d9dab6ccb90f2b656c3b705cff6a070dd95224))
* **deps:** bump k8s.io/apimachinery from 0.30.3 to 0.31.0 ([#1136](https://github.com/partcyborg/tanka/issues/1136)) ([bfecbbc](https://github.com/partcyborg/tanka/commit/bfecbbc07829fc808393636f5cd87d24049b385f))
* **deps:** bump k8s.io/apimachinery from 0.31.0 to 0.31.1 ([#1166](https://github.com/partcyborg/tanka/issues/1166)) ([e0f5839](https://github.com/partcyborg/tanka/commit/e0f58392fab4b4167f40b5d41cb09d92257a96ea))
* **deps:** bump k8s.io/apimachinery from 0.31.1 to 0.31.2 ([#1214](https://github.com/partcyborg/tanka/issues/1214)) ([7292514](https://github.com/partcyborg/tanka/commit/7292514cc6849d3a26a4b8e3a7d152578c076ec2))
* **deps:** bump k8s.io/apimachinery from 0.31.2 to 0.31.3 ([#1242](https://github.com/partcyborg/tanka/issues/1242)) ([42663ac](https://github.com/partcyborg/tanka/commit/42663acd25ddc43a9b1e9ad6028ed9318663f86a))
* **deps:** bump k8s.io/apimachinery from 0.31.3 to 0.31.4 ([#1275](https://github.com/partcyborg/tanka/issues/1275)) ([333fc0d](https://github.com/partcyborg/tanka/commit/333fc0d18f52d6839ff53ee19ce34053689f7461))
* **deps:** bump k8s.io/apimachinery from 0.31.4 to 0.32.0 ([#1283](https://github.com/partcyborg/tanka/issues/1283)) ([b475bca](https://github.com/partcyborg/tanka/commit/b475bca24e40c830316ffbcbbf1fdbfb9383aa18))
* **deps:** bump k8s.io/apimachinery from 0.32.0 to 0.32.1 ([#1318](https://github.com/partcyborg/tanka/issues/1318)) ([d8ba4dd](https://github.com/partcyborg/tanka/commit/d8ba4dd02e3e620e29dc60bd2e5dbbfa250e83f0))
* **deps:** bump k8s.io/apimachinery from 0.32.1 to 0.32.2 ([#1354](https://github.com/partcyborg/tanka/issues/1354)) ([b5bb9ce](https://github.com/partcyborg/tanka/commit/b5bb9cec513e53811f34b6470ed28cf1754ad300))
* **deps:** bump ncipollo/release-action from 1.14.0 to 1.15.0 ([#1313](https://github.com/partcyborg/tanka/issues/1313)) ([8504473](https://github.com/partcyborg/tanka/commit/85044735ab2932f46095fe392411ce155f2fa88d))
* **deps:** bump ncipollo/release-action from 1.15.0 to 1.16.0 ([#1368](https://github.com/partcyborg/tanka/issues/1368)) ([9f92ae2](https://github.com/partcyborg/tanka/commit/9f92ae2add9ea4b48766551fd1ec648756ed0d41))
* **deps:** bump pnpm/action-setup from 4.0.0 to 4.1.0 ([#1339](https://github.com/partcyborg/tanka/issues/1339)) ([7ca7ab1](https://github.com/partcyborg/tanka/commit/7ca7ab1810c3fc8109a66c8985bfdbc3a3b1848f))
* **deps:** bump renovatebot/github-action from 41.0.11 to 41.0.12 ([#1331](https://github.com/partcyborg/tanka/issues/1331)) ([98f7b1d](https://github.com/partcyborg/tanka/commit/98f7b1dadfe5b6601162370f00fef04e244aa5d2))
* **deps:** bump renovatebot/github-action from 41.0.12 to 41.0.13 ([#1342](https://github.com/partcyborg/tanka/issues/1342)) ([18c6f45](https://github.com/partcyborg/tanka/commit/18c6f45b82bc42f80289404623812ec9203df675))
* **deps:** bump renovatebot/github-action from 41.0.13 to 41.0.14 ([#1359](https://github.com/partcyborg/tanka/issues/1359)) ([d2fa103](https://github.com/partcyborg/tanka/commit/d2fa103f162e9310c307f7c92433bef2253487e4))
* **deps:** bump renovatebot/github-action from 41.0.5 to 41.0.6 ([#1268](https://github.com/partcyborg/tanka/issues/1268)) ([bf679bf](https://github.com/partcyborg/tanka/commit/bf679bf09e4aab27c5ce7fc08fb965ce397bee54))
* **deps:** bump renovatebot/github-action from 41.0.6 to 41.0.11 ([#1322](https://github.com/partcyborg/tanka/issues/1322)) ([d46c9bb](https://github.com/partcyborg/tanka/commit/d46c9bb26d187c4185df2549608b403360171334))
* **deps:** bump rossjrw/pr-preview-action from 1.4.7 to 1.4.8 ([#1172](https://github.com/partcyborg/tanka/issues/1172)) ([cffb7e0](https://github.com/partcyborg/tanka/commit/cffb7e0b36e83b58707030c3a06bbd76ae86eef2))
* **deps:** bump rossjrw/pr-preview-action from 1.4.8 to 1.6.0 ([#1316](https://github.com/partcyborg/tanka/issues/1316)) ([40ac63d](https://github.com/partcyborg/tanka/commit/40ac63dda4481cf6080d0b83b09f5209a6abbed2))
* **deps:** bump sigs.k8s.io/yaml from 1.3.0 to 1.4.0 in /acceptance-tests ([#1091](https://github.com/partcyborg/tanka/issues/1091)) ([0c5c8b3](https://github.com/partcyborg/tanka/commit/0c5c8b3511e8542275aaf0291c6c3892400f38e4))
* **deps:** bump softprops/action-gh-release from 2.0.8 to 2.0.9 ([#1217](https://github.com/partcyborg/tanka/issues/1217)) ([637f005](https://github.com/partcyborg/tanka/commit/637f00546a9acc3b5ac602186c9b62c277f85805))
* **deps:** bump tailwindcss from 3.4.3 to 3.4.4 in /docs ([#1064](https://github.com/partcyborg/tanka/issues/1064)) ([f102cd2](https://github.com/partcyborg/tanka/commit/f102cd278797ae123d667ded9fe2444817244865))
* **deps:** bump the acceptance-tests-dependencies group ([#1352](https://github.com/partcyborg/tanka/issues/1352)) ([8102deb](https://github.com/partcyborg/tanka/commit/8102debf3cee8f7e4e1ceb02e887e3dc8625758b))
* **deps:** bump the acceptance-tests-dependencies group in /acceptance-tests with 2 updates ([#1108](https://github.com/partcyborg/tanka/issues/1108)) ([2cbdc89](https://github.com/partcyborg/tanka/commit/2cbdc8987ce0db3ea5c9f0e5e0b5710de1033b85))
* **deps:** bump the acceptance-tests-dependencies group in /acceptance-tests with 2 updates ([#1141](https://github.com/partcyborg/tanka/issues/1141)) ([b9c7d9f](https://github.com/partcyborg/tanka/commit/b9c7d9f12b3a85b5bd1e788a8fb7be9787af91af))
* **deps:** bump the acceptance-tests-dependencies group in /acceptance-tests with 2 updates ([#1165](https://github.com/partcyborg/tanka/issues/1165)) ([1693ebe](https://github.com/partcyborg/tanka/commit/1693ebed6118bc21c39e34772535b3ad9f1f787e))
* **deps:** bump the acceptance-tests-dependencies group with 2 updates ([#1277](https://github.com/partcyborg/tanka/issues/1277)) ([7b5140c](https://github.com/partcyborg/tanka/commit/7b5140c1e421f524131238dc17ae9ccc8fd89e4c))
* **deps:** bump the acceptance-tests-dependencies group with 2 updates ([#1288](https://github.com/partcyborg/tanka/issues/1288)) ([9b33ff5](https://github.com/partcyborg/tanka/commit/9b33ff5a5450e0321932f4bf2acdc9350217de77))
* **deps:** bump the acceptance-tests-dependencies group with 2 updates ([#1317](https://github.com/partcyborg/tanka/issues/1317)) ([8821f83](https://github.com/partcyborg/tanka/commit/8821f832624d394ec17dc1ec5f02c744b033c593))
* **deps:** bump the acceptance-tests-dependencies group with 3 updates ([#1241](https://github.com/partcyborg/tanka/issues/1241)) ([7fdc5e1](https://github.com/partcyborg/tanka/commit/7fdc5e16123ff89871e076a0dffd34f815af7c73))
* **deps:** bump the dagger-dependencies group across 1 directory with 10 updates ([#1147](https://github.com/partcyborg/tanka/issues/1147)) ([19970b3](https://github.com/partcyborg/tanka/commit/19970b37e65bb810305c3c74b918c9660595eebb))
* **deps:** bump the dagger-dependencies group across 1 directory with 3 updates ([#1297](https://github.com/partcyborg/tanka/issues/1297)) ([d7857f0](https://github.com/partcyborg/tanka/commit/d7857f0ab75384aab5c6399c07f3c1d8e17b4565))
* **deps:** bump the dagger-dependencies group in /dagger with 10 updates ([#1287](https://github.com/partcyborg/tanka/issues/1287)) ([5952a38](https://github.com/partcyborg/tanka/commit/5952a38a3cd15c81fc18c8a115913e0fa3d3865d))
* **deps:** bump the dagger-dependencies group in /dagger with 11 updates ([#1099](https://github.com/partcyborg/tanka/issues/1099)) ([223622a](https://github.com/partcyborg/tanka/commit/223622a7d9ebae290c9f739ef00ea4ebe2a5d6a7))
* **deps:** bump the dagger-dependencies group in /dagger with 2 updates ([#1169](https://github.com/partcyborg/tanka/issues/1169)) ([25572d8](https://github.com/partcyborg/tanka/commit/25572d8bf629e4e0389ae46c58c1a26480332846))
* **deps:** bump the dagger-dependencies group in /dagger with 2 updates ([#1174](https://github.com/partcyborg/tanka/issues/1174)) ([2a38b3a](https://github.com/partcyborg/tanka/commit/2a38b3a47838b200d74747f330eda91090bcf5ee))
* **deps:** bump the dagger-dependencies group in /dagger with 2 updates ([#1187](https://github.com/partcyborg/tanka/issues/1187)) ([d260f41](https://github.com/partcyborg/tanka/commit/d260f4149de119ab7bebe5a183274ed92afeda3d))
* **deps:** bump the dagger-dependencies group in /dagger with 3 updates ([#1235](https://github.com/partcyborg/tanka/issues/1235)) ([7023072](https://github.com/partcyborg/tanka/commit/70230726ab7e42f8716597174f1b8d2ef9eb5bce))
* **deps:** bump the dagger-dependencies group in /dagger with 3 updates ([#1271](https://github.com/partcyborg/tanka/issues/1271)) ([ddb7d4e](https://github.com/partcyborg/tanka/commit/ddb7d4e59e6db2e806ed8097cc2069d642b69731))
* **deps:** bump the dagger-dependencies group in /dagger with 3 updates ([#1306](https://github.com/partcyborg/tanka/issues/1306)) ([8d77eb3](https://github.com/partcyborg/tanka/commit/8d77eb3646193b93c1445272e1a7e5a873640c21))
* **deps:** bump the dagger-dependencies group in /dagger with 3 updates ([#1335](https://github.com/partcyborg/tanka/issues/1335)) ([3d19732](https://github.com/partcyborg/tanka/commit/3d197322d1760859709b2de2ffef571ffcfb810e))
* **deps:** bump the dagger-dependencies group in /dagger with 5 updates ([#1202](https://github.com/partcyborg/tanka/issues/1202)) ([f64b61d](https://github.com/partcyborg/tanka/commit/f64b61dc6c2782c19e6ed9a5c0475b2fe2659bee))
* **deps:** bump the dagger-dependencies group in /dagger with 7 updates ([#1168](https://github.com/partcyborg/tanka/issues/1168)) ([8e0c389](https://github.com/partcyborg/tanka/commit/8e0c3896aeb54c52e105c6118f64ef44d42d2bfc))
* **deps:** bump the dagger-dependencies group in /dagger with 9 updates ([#1221](https://github.com/partcyborg/tanka/issues/1221)) ([ef52a66](https://github.com/partcyborg/tanka/commit/ef52a662b6c7dfb4b833115ad082323566e1eae7))
* **deps:** bump the dagger-dependencies group in /dagger with 9 updates ([#1319](https://github.com/partcyborg/tanka/issues/1319)) ([41228bb](https://github.com/partcyborg/tanka/commit/41228bb023f02d54fe432a6ba6b3ebafad01d5e8))
* **deps:** bump the docs-dependencies group across 1 directory with 2 updates ([#1156](https://github.com/partcyborg/tanka/issues/1156)) ([d93fc71](https://github.com/partcyborg/tanka/commit/d93fc71b5440349a06b315b12ecf63d93d3edfec))
* **deps:** bump the docs-dependencies group across 1 directory with 2 updates ([#1220](https://github.com/partcyborg/tanka/issues/1220)) ([06d542e](https://github.com/partcyborg/tanka/commit/06d542e159d35b22d59ba9a736f7ff995534aed0))
* **deps:** bump the docs-dependencies group across 1 directory with 3 updates ([#1289](https://github.com/partcyborg/tanka/issues/1289)) ([7df2d2b](https://github.com/partcyborg/tanka/commit/7df2d2bf1b0d93c86f4183b3dbf2591c951dc3cc))
* **deps:** bump the docs-dependencies group across 1 directory with 4 updates ([#1180](https://github.com/partcyborg/tanka/issues/1180)) ([cf9e926](https://github.com/partcyborg/tanka/commit/cf9e926a7e49e172288c1b2d233f102098bcda6b))
* **deps:** bump the docs-dependencies group across 1 directory with 5 updates ([#1145](https://github.com/partcyborg/tanka/issues/1145)) ([719e91c](https://github.com/partcyborg/tanka/commit/719e91c7eb12ac50eaeeb470cd8363ad404814b4))
* **deps:** bump the docs-dependencies group across 1 directory with 5 updates ([#1205](https://github.com/partcyborg/tanka/issues/1205)) ([6a37172](https://github.com/partcyborg/tanka/commit/6a3717206d8bb2534ea6ac28dab769b63142b375))
* **deps:** bump the docs-dependencies group across 1 directory with 5 updates ([#1296](https://github.com/partcyborg/tanka/issues/1296)) ([cb353f8](https://github.com/partcyborg/tanka/commit/cb353f8c6a21e230e8ca12cc771be93d2b69aa02))
* **deps:** bump the docs-dependencies group in /docs with 2 updates ([#1098](https://github.com/partcyborg/tanka/issues/1098)) ([8818a4f](https://github.com/partcyborg/tanka/commit/8818a4f5a6287f911335e8de8ce18c22d5505a03))
* **deps:** bump the docs-dependencies group in /docs with 2 updates ([#1191](https://github.com/partcyborg/tanka/issues/1191)) ([7a3ee4f](https://github.com/partcyborg/tanka/commit/7a3ee4f666738558e96efb58f66e38895da02e3c))
* **deps:** bump the docs-dependencies group in /docs with 2 updates ([#1226](https://github.com/partcyborg/tanka/issues/1226)) ([24eeca3](https://github.com/partcyborg/tanka/commit/24eeca32610d1cf668930558ac970161956d2393))
* **deps:** bump the docs-dependencies group in /docs with 2 updates ([#1234](https://github.com/partcyborg/tanka/issues/1234)) ([fe13459](https://github.com/partcyborg/tanka/commit/fe134590c8a0efd25ad2fe916dd7917b5be2d5a5))
* **deps:** bump the docs-dependencies group in /docs with 2 updates ([#1254](https://github.com/partcyborg/tanka/issues/1254)) ([b9db0ce](https://github.com/partcyborg/tanka/commit/b9db0ce6d1a6d480534c5e7a4ee2509d29ecb0c9))
* **deps:** bump the docs-dependencies group in /docs with 2 updates ([#1311](https://github.com/partcyborg/tanka/issues/1311)) ([dcc213d](https://github.com/partcyborg/tanka/commit/dcc213ddde50e06c1efe9bdfddb3eb45b50455d0))
* **deps:** bump the docs-dependencies group in /docs with 3 updates ([#1102](https://github.com/partcyborg/tanka/issues/1102)) ([b35a935](https://github.com/partcyborg/tanka/commit/b35a935adb8f093e91bfe169f3791856733fae8b))
* **deps:** bump the docs-dependencies group in /docs with 3 updates ([#1104](https://github.com/partcyborg/tanka/issues/1104)) ([87dc6c8](https://github.com/partcyborg/tanka/commit/87dc6c880d6ae502815f21fc4a0f96744c4c498e))
* **deps:** bump the docs-dependencies group in /docs with 3 updates ([#1109](https://github.com/partcyborg/tanka/issues/1109)) ([7d48662](https://github.com/partcyborg/tanka/commit/7d48662a8626d3451a2c41228ef750e22b834136))
* **deps:** bump the docs-dependencies group in /docs with 3 updates ([#1157](https://github.com/partcyborg/tanka/issues/1157)) ([b8b4cbd](https://github.com/partcyborg/tanka/commit/b8b4cbd7b22621d660c1ae2ce3500eb78316b954))
* **deps:** bump the docs-dependencies group in /docs with 3 updates ([#1240](https://github.com/partcyborg/tanka/issues/1240)) ([48e2c12](https://github.com/partcyborg/tanka/commit/48e2c121b2f7b6a720a1e9a9246b6762749b7ec2))
* **deps:** bump the docs-dependencies group in /docs with 3 updates ([#1307](https://github.com/partcyborg/tanka/issues/1307)) ([7c745e1](https://github.com/partcyborg/tanka/commit/7c745e1fd1f5357637aaa18f2b3afef1992fac1b))
* **deps:** bump the docs-dependencies group in /docs with 3 updates ([#1334](https://github.com/partcyborg/tanka/issues/1334)) ([50b0b27](https://github.com/partcyborg/tanka/commit/50b0b278e1c0948030f62b1ba5dd330230a0cc1f))
* **deps:** bump the docs-dependencies group in /docs with 4 updates ([#1115](https://github.com/partcyborg/tanka/issues/1115)) ([2fa2f49](https://github.com/partcyborg/tanka/commit/2fa2f49b2ee8f96a1ba86b26ab0109b33d53acbe))
* **deps:** bump the docs-dependencies group in /docs with 4 updates ([#1122](https://github.com/partcyborg/tanka/issues/1122)) ([fab0e25](https://github.com/partcyborg/tanka/commit/fab0e2548ceefeacf27274f9b77de23796aaf5a8))
* **deps:** bump the docs-dependencies group in /docs with 4 updates ([#1133](https://github.com/partcyborg/tanka/issues/1133)) ([8f19e71](https://github.com/partcyborg/tanka/commit/8f19e715182d460dbb8a4ff1f8e0472b0b1424c0))
* **deps:** bump the docs-dependencies group in /docs with 4 updates ([#1167](https://github.com/partcyborg/tanka/issues/1167)) ([4f44f78](https://github.com/partcyborg/tanka/commit/4f44f78574ac6924a7a332c5c3409488322e1940))
* **deps:** bump the docs-dependencies group in /docs with 4 updates ([#1278](https://github.com/partcyborg/tanka/issues/1278)) ([7aba4bd](https://github.com/partcyborg/tanka/commit/7aba4bd84d97682d2a86489ac24b1dcff5b88563))
* **deps:** bump the docs-dependencies group in /docs with 4 updates ([#1345](https://github.com/partcyborg/tanka/issues/1345)) ([cd614ed](https://github.com/partcyborg/tanka/commit/cd614ed72c026813115315479c788f7aa6f1fc17))
* **deps:** bump the docs-dependencies group in /docs with 4 updates ([#1358](https://github.com/partcyborg/tanka/issues/1358)) ([28068dc](https://github.com/partcyborg/tanka/commit/28068dcf8ee6451389d83d853bc338155521f506))
* **deps:** bump the docs-dependencies group in /docs with 5 updates ([#1351](https://github.com/partcyborg/tanka/issues/1351)) ([fa1c248](https://github.com/partcyborg/tanka/commit/fa1c248d49abc7caab8dd218c377a2507480e492))
* **deps:** bump the docs-dependencies group in /docs with 7 updates ([#1373](https://github.com/partcyborg/tanka/issues/1373)) ([1b1f030](https://github.com/partcyborg/tanka/commit/1b1f030f56b5bcbf73a4779c5f339d00d7331e35))
* **deps:** bump typescript from 5.4.5 to 5.5.2 in /docs ([#1072](https://github.com/partcyborg/tanka/issues/1072)) ([0ed60bb](https://github.com/partcyborg/tanka/commit/0ed60bb00a216ee304d36283d1dc12fe99838d48))


### 🤖 Continuous Integration

* add renovate ([#1262](https://github.com/partcyborg/tanka/issues/1262)) ([3c9a48d](https://github.com/partcyborg/tanka/commit/3c9a48d04ee48ef6c1f6dbd7b11c28c71c8ed5a2))
* bump x/net to v0.33 in acceptance-tests ([#1298](https://github.com/partcyborg/tanka/issues/1298)) ([50f7149](https://github.com/partcyborg/tanka/commit/50f714975b06d8df6362a84703d9fa1187f534f3))
* create release docker image through workflow-call ([#1246](https://github.com/partcyborg/tanka/issues/1246)) ([fb6380f](https://github.com/partcyborg/tanka/commit/fb6380fb0e46bef6ab1657e9f3bdeeea3997aa35))
* Fix fetch-depth in release workflow ([#1042](https://github.com/partcyborg/tanka/issues/1042)) ([d5d8449](https://github.com/partcyborg/tanka/commit/d5d844986650ba12edf35d1a9537fa602130f7e7))
* fix missing tag name in release draft ([#1118](https://github.com/partcyborg/tanka/issues/1118)) ([1da974d](https://github.com/partcyborg/tanka/commit/1da974d269ef05f9fa308e1714cd8a6485b2723b))
* ignore Astro 5 for now as Starlight does not support it yet ([#1274](https://github.com/partcyborg/tanka/issues/1274)) ([30d907e](https://github.com/partcyborg/tanka/commit/30d907e08374f196a64ad241fecce8618c5ea6eb))
* inject dockerfile dependency versions from workflow ([#1247](https://github.com/partcyborg/tanka/issues/1247)) ([eb9aac0](https://github.com/partcyborg/tanka/commit/eb9aac0f9fa393d9b010d68289cc3981cc7c5a1f))
* lint PR titles ([#1116](https://github.com/partcyborg/tanka/issues/1116)) ([2f62276](https://github.com/partcyborg/tanka/commit/2f6227672c1c94b1d8d362df3452adc61a61c6a7))
* prevent breaking change from creating major release &lt; 1.0.0 ([#1231](https://github.com/partcyborg/tanka/issues/1231)) ([1f34a6e](https://github.com/partcyborg/tanka/commit/1f34a6e5693af10bf0a0d243b51e87be4d017969))
* relevant workflows should react also to ready_for_review ([#1248](https://github.com/partcyborg/tanka/issues/1248)) ([3183efa](https://github.com/partcyborg/tanka/commit/3183efa8cb38abc13db1d8a8e4d585f3d8d6c1fb))
* Remove reference to CHANGELOG in release workflow ([#1041](https://github.com/partcyborg/tanka/issues/1041)) ([cba5ac3](https://github.com/partcyborg/tanka/commit/cba5ac3f320f957195d0a5ba9534dbdfbc7a6452))
* run lint-pr-title workflow on ready_for_review ([#1249](https://github.com/partcyborg/tanka/issues/1249)) ([45c822e](https://github.com/partcyborg/tanka/commit/45c822ed39bef4a50dfc024d6507b5096dd42f71))
* run lint-pr-title workflow on ready-for-review ([45c822e](https://github.com/partcyborg/tanka/commit/45c822ed39bef4a50dfc024d6507b5096dd42f71))
* Run publish-page workflow only on non-forks and docs changes ([#1096](https://github.com/partcyborg/tanka/issues/1096)) ([d53a64e](https://github.com/partcyborg/tanka/commit/d53a64e6a26301471b044484a08045816d822101))
* Support for upload/download-artifacts@4 action ([#979](https://github.com/partcyborg/tanka/issues/979)) ([92ffca5](https://github.com/partcyborg/tanka/commit/92ffca5e8cfa79151fb4eeb34c2e595a4ed3bac8))
* update k3s module to fix breaking acceptance tests ([#1119](https://github.com/partcyborg/tanka/issues/1119)) ([6999896](https://github.com/partcyborg/tanka/commit/6999896b1093f604a618b29d0144dbb793eea2b2))
* use ncipollo/release-action for uploading release artifacts ([#1292](https://github.com/partcyborg/tanka/issues/1292)) ([4df6ff7](https://github.com/partcyborg/tanka/commit/4df6ff7c347b01a177eb730cb9368d4f1d9ec4e1))
* use ubuntu-24.04 and ubuntu-24.04-arm runners ([#1357](https://github.com/partcyborg/tanka/issues/1357)) ([656b9c0](https://github.com/partcyborg/tanka/commit/656b9c0435252d155338b1824fbb99ceb9d758a2))


### 🔧 Miscellaneous Chores

* add catalog-info.yaml for project metadata ([#1194](https://github.com/partcyborg/tanka/issues/1194)) ([2d9ab9a](https://github.com/partcyborg/tanka/commit/2d9ab9a7be30535d5018950eb49dc4bdf470fe86))
* Add codeowners file ([#1085](https://github.com/partcyborg/tanka/issues/1085)) ([f51c85b](https://github.com/partcyborg/tanka/commit/f51c85beed10945a3a3152a63f36813afc9de4d6))
* Add dependabot updates to dagger & acceptance-tests folders ([#1084](https://github.com/partcyborg/tanka/issues/1084)) ([466718a](https://github.com/partcyborg/tanka/commit/466718a0eb781273048fdea9a499cf6883304ce5))
* add support for native `sha256()` function ([#881](https://github.com/partcyborg/tanka/issues/881)) ([e264b4d](https://github.com/partcyborg/tanka/commit/e264b4dda9f6a5ae6357ed873001e57d05c1d53f))
* **ci:** add release-please for release-automation ([#1195](https://github.com/partcyborg/tanka/issues/1195)) ([6918cec](https://github.com/partcyborg/tanka/commit/6918ceccee590e225deb1466fa202211a8a554a6))
* **deps:** update dependency helm to v3.16.4 ([#1290](https://github.com/partcyborg/tanka/issues/1290)) ([336b926](https://github.com/partcyborg/tanka/commit/336b926b117bcb2e3c52facc66a5647ab42d6aa1))
* **deps:** update dependency helm to v3.17.0 ([#1310](https://github.com/partcyborg/tanka/issues/1310)) ([9811551](https://github.com/partcyborg/tanka/commit/9811551e0d030e07900935d5a429e56fa72cfeee))
* **deps:** update dependency helm to v3.17.1 ([#1348](https://github.com/partcyborg/tanka/issues/1348)) ([d0df7f1](https://github.com/partcyborg/tanka/commit/d0df7f1f8bfdc5400b8a500fb38eb177f7803f90))
* **deps:** update dependency kubectl to v1.31.4 ([#1273](https://github.com/partcyborg/tanka/issues/1273)) ([1fbf2a2](https://github.com/partcyborg/tanka/commit/1fbf2a2d78f3431cda5a0e8f7e1f743c894fb851))
* **deps:** update dependency kubectl to v1.32.0 ([#1280](https://github.com/partcyborg/tanka/issues/1280)) ([feac755](https://github.com/partcyborg/tanka/commit/feac755c7e353136f92bd345b8bfa4ba24205128))
* **deps:** update dependency kubectl to v1.32.1 ([#1309](https://github.com/partcyborg/tanka/issues/1309)) ([2a6ae21](https://github.com/partcyborg/tanka/commit/2a6ae21326cc3550ac33276f214520d18abd76ab))
* **deps:** update dependency kubectl to v1.32.2 ([#1349](https://github.com/partcyborg/tanka/issues/1349)) ([a71826d](https://github.com/partcyborg/tanka/commit/a71826de254863af2af27f71468c2cdfa9822ebf))
* **deps:** update dependency kustomize to v5.6.0 ([#1308](https://github.com/partcyborg/tanka/issues/1308)) ([43069eb](https://github.com/partcyborg/tanka/commit/43069ebb99fa51aab9eeb825a0db1987617ddc30))
* **docs:** bump to tailwind 4.0 ([#1327](https://github.com/partcyborg/tanka/issues/1327)) ([6c5d340](https://github.com/partcyborg/tanka/commit/6c5d340ef9cdd8992f9e96f421e4f5ae7ee81ef1))
* Group dependency updates ([#1095](https://github.com/partcyborg/tanka/issues/1095)) ([f469574](https://github.com/partcyborg/tanka/commit/f4695749b75a758721f4f6a52cf150233c009a8b))
* **jsonnet:** update to 0.19.1 ([#783](https://github.com/partcyborg/tanka/issues/783)) ([0ddba90](https://github.com/partcyborg/tanka/commit/0ddba90b45f3bb97c7da92a187dd18a5f5363a96))
* **main:** release 0.30.0 ([#1230](https://github.com/partcyborg/tanka/issues/1230)) ([d712789](https://github.com/partcyborg/tanka/commit/d712789d786f6d3892db26af549c37add4d05223))
* **main:** release 0.30.1 ([#1239](https://github.com/partcyborg/tanka/issues/1239)) ([bae4edb](https://github.com/partcyborg/tanka/commit/bae4edb653b26da962ad05c5f124cc0f5443a8ec))
* **main:** release 0.30.2 ([#1258](https://github.com/partcyborg/tanka/issues/1258)) ([7ced3f9](https://github.com/partcyborg/tanka/commit/7ced3f94234b5cbdb2edd879abb8bea72f74ae00))
* **main:** release 0.31.0 ([#1261](https://github.com/partcyborg/tanka/issues/1261)) ([d79a53e](https://github.com/partcyborg/tanka/commit/d79a53e056495892fc202d2123a698ecb5e8ecb7))
* **main:** release 0.31.1 ([#1291](https://github.com/partcyborg/tanka/issues/1291)) ([c8869ec](https://github.com/partcyborg/tanka/commit/c8869ec0245fff15aee68b2f732d074a8af9f63f))
* **main:** release 0.31.2 ([#1305](https://github.com/partcyborg/tanka/issues/1305)) ([6de85c3](https://github.com/partcyborg/tanka/commit/6de85c304c5f3f416d07a6b007cb6c8797b0da13))
* pin login-to-dockerhub action ([#1365](https://github.com/partcyborg/tanka/issues/1365)) ([3d87962](https://github.com/partcyborg/tanka/commit/3d879625b5a61ecd7fbe34df55b61fc35b26c7ba))
* **release:** Changelog for 0.16 stable ([#565](https://github.com/partcyborg/tanka/issues/565)) ([774c664](https://github.com/partcyborg/tanka/commit/774c664789e28909961750a7a23491974a521c1a))
* **release:** Changelog for 0.17 stable ([#580](https://github.com/partcyborg/tanka/issues/580)) ([3a1289b](https://github.com/partcyborg/tanka/commit/3a1289b985301dc55bc24e95bcb1d3e1bdc2e825))
* **release:** Changelog for 0.17.1 ([3bc0931](https://github.com/partcyborg/tanka/commit/3bc0931b899432ab1e9edcff9c4e81a1bd3250b7))
* **release:** Changelog for 0.17.3 ([#599](https://github.com/partcyborg/tanka/issues/599)) ([8b680de](https://github.com/partcyborg/tanka/commit/8b680de501685b534efba32a07dea408454bb73b))
* s/k8s-alpha/k8s-libsonnet ([#579](https://github.com/partcyborg/tanka/issues/579)) ([3cad5ef](https://github.com/partcyborg/tanka/commit/3cad5efcd9bb53f6bf62a7e4f8a3e414f634ab70))
* update location from where kubectl is downloaded from ([#1257](https://github.com/partcyborg/tanka/issues/1257)) ([c18e134](https://github.com/partcyborg/tanka/commit/c18e134590d09e331f2cba3467d6399a005f1bc9))
* Use Dockerfile as source for the Go version ([#985](https://github.com/partcyborg/tanka/issues/985)) ([d2637d2](https://github.com/partcyborg/tanka/commit/d2637d2e8501c6c5aed5beda4448860beecccc70))


### ✅ Tests

* add acceptance test for tk export -l ([#1347](https://github.com/partcyborg/tanka/issues/1347)) ([3109dc9](https://github.com/partcyborg/tanka/commit/3109dc9d63da175d95646c955c34ff9934ea97da))


### ♻️ Code Refactoring

* define jsonnet-implementation flag in a single place ([#1260](https://github.com/partcyborg/tanka/issues/1260)) ([d30882b](https://github.com/partcyborg/tanka/commit/d30882bcd28e77976f7028365851f4911eeb5a1e))
